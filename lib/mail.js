...
export async function sendmail(formData) {
  ...
  const transporter = nodemailer.createTransport({
    ...
    maxConnections: 5, // define the maximum number of connections
    maxMessages: 100, // optional: how many messages to send through one connection
    rateLimit: 10, // optional: to limit sending rate to avoid being blocked
    // tls: {
    //   ciphers: "SSLv3",
    // },
    // requireTLS: true,
