...
export default function Footer() {
  return (
    <footer className="w-[100vw] h-[150vh] xl:h-[40vh] min-h-max px-4 grid xl:grid-cols-[35%_9%_9%_9%_14%_20%] grid-cols-[40%_60%] xl:grid-rows-[70%_30%] grid-rows-[30%_16.6%_16.6%_16.6%_20%] xl:gap-4 gap-2 relative mb-10 xl:px-16 md:px-4 mt-4 justify-items-center items-center">
      <div className="foot-cards w-full min-h-max h-full rounded-[2rem]  xl:cols-start-1 xl:col-span-1 xl:row-span-2 xl:row-start-1 cols-start-1 col-span-2 row-span-1 row-start-1 flex flex-col justify-between items-start">
        <Image
        ...
        />
        <div>
          <h3 className="xl:text-xl  text-white">
            Transforming the Digital Landscape
          </h3>
          <p className="xl:text-md text-white font-thin">
      ...
      <div className=" foot-cards w-full min-h-max h-full rounded-[2rem]  xl:cols-start-2 xl:col-span-4 xl:row-span-1 xl:row-start-1 cols-start-1 col-span-2 row-span-2 row-start-5 flex flex-col justify-center items-start lg:gap-[2vh]">
        <div>
          <h3 className="lg:text-[2vw] text-[6vw] text-white">
            Subscribe to our newsletter
          </h3>
          <p className="text-white font-thin lg:text-[1.1vw] text-[3vw]">
            {" "}
      ...
      <div className="foot-cards w-full h-full rounded-[2rem] xl:cols-start-4 xl:col-span-1 xl:row-span-1 xl:row-start-2 cols-start-1 col-span-1 row-span-1 row-start-4 flex justify-center items-center">
        <a
          href={
            "https://wa.me/971568383467?text=I'm%20interested%20in%20learning%20more%20about%20Manasa%20Studios'%20services."
          }
          target="_blank"
        >
          {" "}
