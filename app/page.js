...
export default function Home() {
  ...
  return (
    <main className="w-screen lg:px-8 px-2 absolute top-0 overflow-x-clip ">
      <Hero />
      <section className="pt-40 px-4 relative  overflow-x-clip">
      ...
      <section className="pt-40 px-4 relative mt-24 overflow-x-clip">
        ...
        <div className="flex flex-wrap flex-col gap-4 flex-1 min-h-[70rem] max-h-[90rem]">
          ...
          <div className="cards w-[50%] h-[30rem] rounded-3xl overflow-clip p-10 relative hover:-translate-y-1 transition-all duration-500 cursor-pointer">
            <Image
              ...
              fill
              className="object-cover object-top hover:object-bottom transition-all duration-500"
              alt="tweleve logo"
            />
            <h1 className="text-3xl text-black relative">
              Corinna Coaching [Web Design + Development]
            </h1>
          </div>
        </div>
      </section>
      <section className="pt-40 px-4 relative mt-16 overflow-x-clip">
        <h1 className="text-white text-6xl mb-24">Methadology</h1>
        <div className="flex-1 max-w-screen flex flex-wrap gap-20 justify-around mt-16 space-y-10 text-white">
          <div className="cards w-80 h-[22rem] rounded-3xl translate-y-8 relative">
            ...
            <h2 className={"text-2xl mb-5"}>Some Step</h2>
            <p className={"text-sm w-[90%] font-light"}>
              Some Aliqua aute velit eiusmod minim nulla irure ea Lorem
              voluptate amet qui qui sunt. Dolor duis commodo cillum officia do
              ullamco. In est qui velit laboris. Laborum laborum tempor est amet
              non id.
            </p>
          ...
          <div className="cards w-80 h-[22rem] rounded-3xl -translate-y-24 relative">
            ...
            <h2 className={"text-2xl mb-5"}>Some Step</h2>
            <p className={"text-sm w-[90%] font-light"}>
              Some Reprehenderit aliqua laborum magna exercitation sit ullamco.
              Mollit magna cupidatat enim aute veniam eu esse sit officia
              cupidatat sit commodo excepteur ex. Laborum pariatur consectetur
              voluptate esse do ea reprehenderit minim non do in voluptate aute.
            </p>
          ...
          <div className="cards w-80 h-[22rem] rounded-3xl relative">
            ...
            <h2 className={"text-2xl mb-5"}>Some Step</h2>
            <p className={"text-sm w-[90%] font-light"}>
              Some Laborum consequat enim sint magna velit ullamco. Est esse
              excepteur deserunt deserunt non culpa nostrud id id et id tempor
              cupidatat. Aliquip eu in labore pariatur ullamco consectetur dolor
              esse dolore ut id ipsum laboris. Excepteur nulla duis dolore esse
              fugiat proident irure aute aute nostrud pariatur aute magna velit.
            </p>
          ...
          <div className="w-screen flex gap-60 justify-center">
            <div className="cards w-80 h-[22rem] rounded-3xl relative">
              ...
              <h2 className={"text-2xl mb-5"}>Some Step</h2>
              <p className={"text-sm w-[90%] font-light"}>
                Some Do sunt ad elit ad adipisicing ex tempor ut proident
                laboris ex reprehenderit. Proident enim cillum nisi cillum
                commodo minim excepteur. Quis cillum aute sunt voluptate esse
                nulla ut. Occaecat eiusmod cillum sunt commodo cillum enim nisi.
                Consequat non fugiat voluptate occaecat commodo sit laboris
                occaecat id elit.
              </p>
            ...
            <div className="cards w-80 h-[22rem] rounded-3xl translate-y-16">
              ...
              <h2 className={"text-2xl mb-5"}>Some Step</h2>
              <p className={"text-sm w-[90%] font-light"}>
                Some Dolor nostrud anim consectetur quis qui deserunt. Magna
                laboris non et cupidatat sint mollit enim et ut. Sunt duis ea
                excepteur eiusmod officia sit fugiat et. Ipsum incididunt non
                Lorem proident sit magna. Eu fugiat incididunt anim dolor minim
                esse duis id.
              </p>
      ...
      <section className="pt-40 px-4 relative mt-16 overflow-x-clip">
        <div className="w-full h-[40rem] cards rounded-3xl flex justify-center flex-col items-center gap-8 relative ">
          ...
          <div className="w-[50%] h-auto relative">
            ...
            />
            <button className="absolute top-[50%] -translate-y-[50%] right-1 hover:bg-slate-400 bg-slate-300 rounded-full h-[90%] w-[20%]">
              {" "}
              Submit
            </button>
          </div>
      ...
      <section className=" px-4 relative flex flex-col justify-center mb-16 overflow-x-clip">
        <div className="flex gap-10 h-[20rem] my-10 ">
          <div className="flex-1 cards rounded-3xl"></div>
          <div className="flex-1 cards rounded-3xl"></div>
        </div>
        <button className="border-0 bg-transparent text-white opacity-70 hover:opacity-100">
          BACK TO TOP
        </button>
      </section>
    </main>
